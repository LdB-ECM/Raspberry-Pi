...
.--------------------------------------------------------------------------*/
uintptr_t setSoftIrqFuncAddress (void(*ARMaddress)(void));
...
/*-[Context_Switch]---------------------------------------------------------}
. Executes a context switch between the two pointers to context stacks
.--------------------------------------------------------------------------*/
void Context_Switch (uint32_t* oldstack, uint32_t* newstack);
